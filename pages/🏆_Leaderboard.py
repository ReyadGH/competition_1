...
def leaderboard_page() -> None:
    ...
    if not leaderboard_df.empty:
        ...
        highest_scores_df = highest_scores_df.sort_values(by="Score", ascending=False)  # Sort by score
        ...
        st.info("No submissions yet. Be the first to conquer the leaderboard and win the title!")
